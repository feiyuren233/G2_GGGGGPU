...
class UnaryExpressionNode : public ExpressionNode
{
  ...
  public:
    UnaryExpressionNode(int op, ExpressionNode *expr) : m_op(op), m_expr(expr) {}
...
class BinaryExpressionNode : public ExpressionNode
{
  ...
  public:
    BinaryExpressionNode(int op, ExpressionNode *leftExpr, ExpressionNode *rightExpr) : m_op(op), m_leftExpr(leftExpr), m_rightExpr(rightExpr) {}
...
class IntLiteralNode : public ExpressionNode
{
  ...
  public:
    IntLiteralNode(int val) : m_val(val) {}
...
class FloatLiteralNode : public ExpressionNode
{
  ...
  public:
    FloatLiteralNode(float val) : m_val(val) {}
...
class BooleanLiteralNode : public ExpressionNode
{
  ...
  public:
    BooleanLiteralNode(bool val) : m_val(val) {}
...
class DeclarationNode : public ASTNode
{
  ...
  public:
    DeclarationNode(const std::string &variableName, bool isConst, int type, ExpressionNode *initValExpr = nullptr) : m_variableName(variableName), m_isConst(isConst), m_type(type), m_initValExpr(initValExpr) {}
...
class IdentifierNode : public VariableNode
{
  ...
  public:
    IdentifierNode(const std::string &id) : m_id(id) {}
...
class FunctionNode : public ExpressionNode
{
  ...
  public:
    FunctionNode(const std::string &functionName, ExpressionsNode *argExprs) : m_functionName(functionName), m_argExprs(argExprs) {}
...
class IfStatementNode : public StatementNode
{
  ...
  public:
    IfStatementNode(ExpressionNode *condExpr, StatementNode *thenStmt, StatementNode *elseStmt = nullptr) : m_condExpr(condExpr), m_thenStmt(thenStmt), m_elseStmt(elseStmt) {}
...
class WhileStatementNode : public StatementNode
{
  ...
  public:
    WhileStatementNode(ExpressionNode *condExpr, StatementNode *bodyStmt) : m_condExpr(condExpr), m_bodyStmt(bodyStmt) {}
...
class AssignmentNode : public StatementNode
{
  ...
  public:
    AssignmentNode(VariableNode *var, ExpressionNode *newValExpr) : m_var(var), m_newValExpr(newValExpr) {}
...
class NestedScopeNode : public StatementNode
{
  ...
  public:
    NestedScopeNode(DeclarationsNode *decls, StatementsNode *stmts) : m_decls(decls), m_stmts(stmts) {}
...
class ScopeNode : public ASTNode
{
  ...
  public:
    ScopeNode(DeclarationsNode *decls, StatementsNode *stmts) : m_decls(decls), m_stmts(stmts) {}
