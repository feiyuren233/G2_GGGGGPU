...
for root, dirs, files in os.walk(test_dir):
    if root == test_dir:
        for test_target_file in files:
            ...
            p = subprocess.Popen([compiler467_exe, '-Dx', test_dir + test_target_file],
            ...
            with open(prev_dir + test_target_file, 'r') as prev_file:
                ...
                if prev_total_out.replace(" ", "") == total_out.replace(" ", ""):
                    print '    Passed.'
                    passed_count += 1
                else:
                    print '    Failed.'
                    ...
                    for total_out_line in total_out_lines:
                        if total_out_line.replace(" ", "") != prev_total_out_lines[line-1].replace(" ", ""):
                            print "Line: " + str(line) + ":"
...
print '##########'
print 'Successful! Total Passed: ' + str(passed_count)
