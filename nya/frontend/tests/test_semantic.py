...
test_semantic_assigned_script = './tests/test_semantic_assigned.py'
test_semantic_const_script = './tests/test_semantic_const.py'
test_semantic_core_script = './tests/test_semantic_core.py'
...
p = subprocess.Popen(['python', test_semantic_assigned_script],
...
p = subprocess.Popen(['python', test_semantic_const_script],
                     stdout=subprocess.PIPE, stderr=subprocess.PIPE)
run_out, run_err = p.communicate()
total_out = run_err + run_out
print total_out
...
p = subprocess.Popen(['python', test_semantic_core_script],
                     stdout=subprocess.PIPE, stderr=subprocess.PIPE)
run_out, run_err = p.communicate()
total_out = run_err + run_out
print total_out
